...
<html lang="es">
   ...
   <body>
      ...
      <div style="padding-left: 11%;">
         ...
         <h5 style="color:#717981;"><a style="text-decoration:none;color:#717981;" href="zona.admin.php">Inicio</a> | <a style="text-decoration:none;color:#717981;" href="administrarusu.php"> Administrar Usuarios | <a style="text-decoration:none;color:#717981;" href="reservas.php"> Reservas</a></h5>
      </div>
      <div class="row">
         <div class="one-column">
            ...
            <a href="activa.php">
               ...
               <p style='font-size:30px; margin:0;color:white;'>0</p>
               <p style='font-size:20px; margin:0; color:white;'>MESAS OCUPADAS</p>
               </div>
            </a>
            <a href="reciente.php">
